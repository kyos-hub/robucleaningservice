...
import imgAboutHero from "@/assets/photos/robu-office-mopping.jpg";
import imgAboutSection from "@/assets/photos/robu-pest-control-garden.jpg";

const aboutAsset = imgAboutSection;
const heroImg = imgAboutHero;
