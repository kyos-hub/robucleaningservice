...
import imgExportHero from "@/assets/photos/robu-waste-bins.jpg";
import imgExportPackhouse from "@/assets/photos/robu-hospital-corridor.jpg";

const heroImg = imgExportHero;
const packhouseImg = imgExportPackhouse;
